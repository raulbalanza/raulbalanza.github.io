...
VertexNormalsHelper from https://github.com/mrdoob/three.js/blob/master/examples/jsm/helpers/VertexNormalsHelper.js
	...
	update() {
		...
		if ( objGeometry ) {
			...
			for ( let j = 0, jl = objPos.count; j < jl; j ++ ) {
				...
				position.setXYZ( idx, _v1.x, _v1.y+200, _v1.z );

				idx = idx + 1;

				position.setXYZ( idx, _v2.x, _v2.y+200, _v2.z );
